...
check_call(MPath + ' extract gct100.fa gct_aln.bam -q 2 -o test1', shell=True)
...
check_call(MPath + ' extract gcg100.fa gcg_aln.bam -q 2 -o test2', shell=True)
...
check_call(MPath + ' extract gcg100.fa gcg_aln.bam -q 10 -o test3', shell=True)
...
check_call(MPath + ' extract --methylKit --CHH --CHG gcg100.fa gcg_aln.bam -q 2 -o test4', shell=True)
...
check_call(MPath + ' extract --minDepth 2 gcg100.fa gcg_aln.bam -q 2 -o test5', shell=True)
...
check_call(MPath + ' extract --ignoreFlags 0xD00 gcg100.fa gcg_aln.bam -q 2 -o test6', shell=True)
...
check_call(MPath + ' extract --requireFlags 0xD00 gcg100.fa gcg_aln.bam -q 2 -o test7', shell=True)
...
check_call(MPath + ' extract --nOT 50,50,40,40 gcg100.fa gcg_aln.bam -q 2 -o test8', shell=True)
...
check_call(MPath + ' extract -p 1 -q 0 -o test9 --minOppositeDepth 3 --maxVariantFrac 0.25 gcg100.fa gcg_with_variants.bam', shell=True)
